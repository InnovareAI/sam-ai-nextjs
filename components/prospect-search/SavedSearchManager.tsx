...
export function SavedSearchManager({
  ...
  const handleSaveSearch = async (params: LinkedInSearchParams, urlResult: SearchUrlResult) => {
    if (!newSearchName.trim()) {
      console.error("ERROR:", 'Search name is required');
      return;
    }
    ...
    try {
      ...
      console.log("SUCCESS:", 'Search configuration saved');
    } catch (error) {
      console.error("ERROR:", 'Failed to save search configuration');
    }
  };
  ...
  const duplicateSearch = async (config: SearchConfiguration) => {
    try {
      ...
      console.log("SUCCESS:", 'Search configuration duplicated');
    } catch (error) {
      console.error("ERROR:", 'Failed to duplicate search configuration');
    }
  };
  ...
  const handleDeleteSearch = async (config: SearchConfiguration) => {
    try {
      ...
      console.log("SUCCESS:", 'Search configuration deleted');
    } catch (error) {
      console.error("ERROR:", 'Failed to delete search configuration');
    }
  };
