...
export function MessageManager({
  ...
  const handleAnalyzeMessage = async (content: string) => {
    ...
    try {
      ...
      console.log("SUCCESS:", 'Message analyzed successfully');
      return analysis;
    } catch (error) {
  ...
  const handleCreateVariant = async () => {
    ...
    try {
      ...
      console.log("SUCCESS:", 'Message variant created successfully');
    } catch (error) {
      console.error("ERROR:", 'Failed to create message variant');
    }
  };
