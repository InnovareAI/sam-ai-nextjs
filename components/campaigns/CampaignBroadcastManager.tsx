...
export function CampaignBroadcastManager({
  ...
  const loadCampaignWorkflow = async () => {
    try {
      ...
      console.error("ERROR:", 'Failed to load campaign workflow');
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleStartBroadcast = async () => {
    try {
      ...
      console.log("SUCCESS:", 'Campaign broadcast started successfully');
      onWorkflowUpdate?.(workflow?.workflow_id || '', 'active');
    } catch (error) {
      console.error('Error starting broadcast:', error);
      console.error("ERROR:", 'Failed to start campaign broadcast');
    } finally {
  ...
  const handlePauseBroadcast = async () => {
    try {
      ...
      await loadCampaignProgress();
      console.log("SUCCESS:", 'Campaign broadcast paused');
      onWorkflowUpdate?.(workflow?.workflow_id || '', 'paused');
    } catch (error) {
      console.error('Error pausing broadcast:', error);
      console.error("ERROR:", 'Failed to pause campaign broadcast');
    }
  };
  ...
  const handleResumeBroadcast = async () => {
    try {
      ...
      await loadCampaignProgress();
      console.log("SUCCESS:", 'Campaign broadcast resumed');
      onWorkflowUpdate?.(workflow?.workflow_id || '', 'active');
    } catch (error) {
      console.error('Error resuming broadcast:', error);
      console.error("ERROR:", 'Failed to resume campaign broadcast');
    }
  };
  ...
  const handleAddMessage = async () => {
    ...
    try {
      ...
      console.log("SUCCESS:", 'Message added to automation successfully');
    } catch (error) {
      console.error('Error adding message:', error);
      console.error("ERROR:", 'Failed to add message to automation');
    }
  };
  ...
  const handleUpdateMessage = async (messageId: string, updates: Partial<MessageSequenceItem>) => {
    try {
      ...
      console.error("ERROR:", 'Failed to update message');
    }
  };
  ...
  const handleRemoveMessage = async (messageId: string) => {
    try {
      ...
      console.log("SUCCESS:", 'Message removed from automation');
    } catch (error) {
      console.error('Error removing message:', error);
      console.error("ERROR:", 'Failed to remove message');
    }
  };
